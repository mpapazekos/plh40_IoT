...
import plh40_iot.intermediate_manager.DeviceGroup.CouldNotCreateDevice
...
import plh40_iot.intermediate_manager.{DeviceManager, DeviceGroup }
import plh40_iot.domain.RegisterInfo

object RegisterListener {
  
    import DeviceManager.RegisterDevice
    import DeviceGroup.{DeviceCreated, AlreadyRunning, Response}
